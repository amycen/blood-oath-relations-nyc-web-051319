...
evil_witches = Cult.new("Evil Witches","NYC","1920","WE THE BEST!",25)
...
puts evil_witches.recruit_follower(jon, "2018-10-19")
puts sam.join_cult(evil_witches,"2019-11-23")
